...
1. Open the **Catalog UI** at `http://<MY_HOST>:28180/api/catalog` — should load with empty tables
2. Open the **RustFS UI** at `http://<MY_HOST>:9001` — login with `participant-admin` / `participant-secret-2024`
...
| Problem | Solution |
|---------|----------|
| `Cannot connect to localhost:28180` | Use your machine's IP instead of localhost |
